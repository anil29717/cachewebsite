...
const caseStudies = [
  // Telecom Case Studies
  {
    ...
    image: "/servicesimages/cyberimage.jpg",
  ...
  },
  {
    ...
    image: "/servicesimages/managedservices.jpg",
  ...
  },
  {
    ...
    image: "/servicesimages/aiimage.jpg",
...
export function CaseStudiesSection() {
  ...
  // Handle URL parameter for active case study
  useEffect(() => {
  ...
  return (
    <section className="py-20 bg-white" id="success-stories">
            ...
            >
              <Card className="overflow-hidden h-auto hover:shadow-2xl transition-all duration-300 group bg-gradient-to-br from-white to-gray-50 border-0 shadow-lg">
                <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 !== 0 ? 'lg:grid-flow-col-dense' : ''}`}>
                  <div className={`relative h-48 lg:h-52 ${index % 2 !== 0 ? 'lg:col-start-2' : ''}`}>
                    <ImageWithFallback
                      src={study.image}
                      alt={study.title}
                  ...
                  <CardContent className={`p-2 lg:p-8 flex flex-col justify-between h-full ${index % 2 !== 0 ? 'lg:col-start-1' : ''} relative`}>
        ...
        {selectedStudy && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-white rounded-2xl w-full max-w-4xl h-[60vh] relative shadow-2xl overflow-hidden"
            >
              {/* Modal Header */}
              ...
              <div className="p-6 h-full overflow-hidden">
                {/* Title and Industry */}
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-black mb-2 line-clamp-1">{selectedStudy.title}</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-red-600 leading-relaxed text-sm line-clamp-2 font-medium">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-green-600 leading-relaxed text-sm line-clamp-2 font-medium">
