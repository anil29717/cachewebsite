...
export function Partners() {
  const partnerLogos = [
    ...
    { name: 'Dell', logo: '/community/delllogo.png' },
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {partnerLogos.map((partner, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:from-red-50 group-hover:to-red-100 overflow-hidden"> {/* Added overflow-hidden */}
                  <ImageWithFallback
                    src={partner.logo}
                    alt={partner.name}
