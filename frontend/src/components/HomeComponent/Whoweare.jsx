      ...
      <div className="container mx-auto px-6 lg:px-20 text-center">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-lg leading-relaxed animate-fade-in-up">
            At <span className="font-bold text-red-600  inline-block">Cache Digitech</span>, we are passionate about delivering cutting-edge
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div className="group bg-white p-6 rounded-2xl border-2 border-transparent shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slide-in-left">
          ...
          <div className="group bg-white p-6 rounded-2xl border-2 border-transparent  shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slide-in-up">
            <div className="w-14 h-14 bg-gradient-to-br from-red-300 to-red-700 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
              <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-3  transition-colors duration-300">
              <span className="inline-block " style={{animationDelay: '0.1s'}}>Data AI</span>
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
          ...
          <div className="group bg-white p-6 rounded-2xl border-2 border-transparent shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slide-in-right">
            <div className="w-14 h-14 bg-gradient-to-br from-red-300 to-red-700 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
              <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-3  transition-colors duration-300">
              <span className="inline-block " style={{animationDelay: '0.2s'}}>Cyber Security</span>
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
          ...
          <div className="group bg-white p-6 rounded-2xl border-2 border-transparent  shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slide-in-left">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-3  transition-colors duration-300">
              <span className="inline-block " style={{animationDelay: '0.3s'}}>Cloud Solutions</span>
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
          ...
          <div className="group bg-white p-6 rounded-2xl border-2 border-transparent  shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slide-in-up">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-3  transition-colors duration-300">
              <span className="inline-block " style={{animationDelay: '0.4s'}}>Infra & Audit</span>
            </h3>
