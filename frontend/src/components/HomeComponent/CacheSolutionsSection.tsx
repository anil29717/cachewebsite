...
const capabilities: Capability[] = [
  {
    ...
    icon: '🔍',
    subtopics: [
      { name: 'Infra', description: 'Infrastructure audit evaluates physical and virtual assets like servers, storage, and operating systems to ensure performance, compliance, and cost-effectiveness' },
      { name: 'Cloud', description: 'Cloud infrastructure auditing to evaluate cloud architecture, security posture, cost optimization opportunities, and compliance with best practices.' },
      { name: 'Cyber', description: 'Cybersecurity auditing to identify security gaps, assess threat vulnerabilities, and ensure compliance with security standards and regulations.' },
      { name: 'Networking', description: 'Network infrastructure auditing to analyze network performance, security configurations, and identify optimization opportunities.' },
      { name: 'Data & AI', description: 'Data and AI system auditing to evaluate data governance, AI model performance, and ensure ethical AI implementation practices.' }
    ]
  },
  {
    name: 'Consult',
    icon: '💡',
    subtopics: [
      { name: 'Infra', description: 'Strategic infrastructure consulting to design scalable, resilient systems that align with your business objectives and growth plans.' },
      { name: 'Cloud', description: 'Cloud strategy consulting to guide your cloud adoption journey, optimize costs, and maximize the benefits of cloud technologies.' },
      { name: 'Cyber', description: 'Cybersecurity consulting to develop comprehensive security strategies, risk management frameworks, and incident response plans.' },
      { name: 'Networking', description: 'Network consulting to design efficient, secure network architectures that support your business operations and future growth.' },
      { name: 'Data & AI', description: 'Data and AI consulting to develop data strategies, implement AI solutions, and drive data-driven decision making across your organization.' }
    ]
  },
  {
    name: 'Design',
              ...
              <AnimatePresence>
                {doorSliderOpen && (
                  ...
                  >
                    {/* Left Door Panel */}
                    <motion.div
                      className="absolute left-0 top-0 w-1/2 h-full bg-black/20 backdrop-blur-sm"
                    ...
                    {/* Right Door Panel */}
                    <motion.div
                      className="absolute right-0 top-0 w-1/2 h-full bg-black/20 backdrop-blur-sm"
                      variants={doorPanelVariants}
                      initial="closed"
                      animate="open"
                      exit="closed"
