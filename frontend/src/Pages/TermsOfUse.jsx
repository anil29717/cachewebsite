  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p>
            With 34+ years of experience as a leading system integration company in India, Cache DigTech specializes in Technology Integration, Digital Transformation, Infrastructure, and IT Consulting Solutions.
          </p>
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Build empowered and digitally resilient ecosystems for partners, vendors, and customers to create meaningful impact across domains.
              </p>
            </div>
            <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
              <div className="flex items-center space-x-3 mb-2">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Provide innovative technology solutions and services that enable customers and teams to thrive through cutting-edge technologies.
              </p>
            </div>
          </div>
        </>
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-28 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-gray-600">Cache Digitech Technology Solutions • Effective Date: January 15, 2025</p>
      </div>
