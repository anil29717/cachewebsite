      ...
      <div className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center bg-gradient-to-r from-red-600 to-red-700 text-white p-12 rounded-lg">
            <h2 className="text-3xl font-bold mb-4">Connect Your Business Future</h2>
            <p className="text-xl mb-8 opacity-90">
              Transform your network infrastructure with our expert {currentTab.label.toLowerCase()} services
            </p>
